...
import seq2seq.utils.attention_data_loader as data_loader
import seq2seq.utils.hook as hook
import seq2seq.utils.utils as utils
from seq2seq.transformer.model import Model
...
def main(mode):
  ...
  tf.contrib.learn.learn_runner.run(
    experiment_fn=experiment_fn,  # Experiment function.
    run_config=run_config,        # Some model information.
    schedule=mode,                # A mode, [train, eval, predict].
    hparams=params                # hyper parameters.
  )
